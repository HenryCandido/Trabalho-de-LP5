        ...
        <div class="container">
            ...
            <form action="FrontController?action=ExcluirProduto" method="post" name="frmExcluirProduto" onsubmit="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="textCep" name="textCep" value="${produto.cepProduto}" readonly>
                </div>
                <div class="form-group">
                    <label for="textCpf">CPF</label>
                    <input type="text" class="form-control" id="textCpf" name="textCpf" value="${produto.cpfProduto}" readonly>
                </div>
